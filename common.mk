...
prep-semaphore:
	$(SEMAPHORE) && if [ (df -T | grep "/$$" | grep ext) ]; then (sudo swapoff -a && sudo dd if=/dev/zero of=/swapfile bs=1M count=8192 && sudo mkswap /swapfile && sudo chmod 0600 /swapfile && sudo swapon /swapfile); fi
