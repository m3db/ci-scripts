...
prep-semaphore:
	$(SEMAPHORE) && (df -T | grep "/$$" | grep ext && \
		sudo swapoff -a && sudo dd if=/dev/zero of=/swapfile bs=1M count=8192 && sudo mkswap /swapfile && sudo chmod 0600 /swapfile && sudo swapon /swapfile)
